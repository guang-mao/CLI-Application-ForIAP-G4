...
typedef struct __attribute__((packed)) queue8
{
    uint16_t    Front;
    uint16_t    Rear;
    uint8_t     PBase[8 + 1];
...
typedef struct __attribute__((packed)) queue16
{
    uint16_t    Front;
    uint16_t    Rear;
    uint8_t     PBase[16 + 1];
...
typedef struct __attribute__((packed)) queue32
{
    uint16_t    Front;
    uint16_t    Rear;
    uint8_t     PBase[32 + 1];
...
typedef struct __attribute__((packed)) queue64
{
    uint16_t    Front;
    uint16_t    Rear;
    uint8_t     PBase[64 + 1];
...
typedef struct __attribute__((packed)) queue128
{
    uint16_t    Front;
    uint16_t    Rear;
    uint8_t     PBase[128 + 1];
...
typedef struct __attribute__((packed)) queue256
{
    uint16_t    Front;
    uint16_t    Rear;
    uint8_t     PBase[256 + 1];
...
typedef struct __attribute__((packed)) queue1024
{
    uint16_t    Front;
    uint16_t    Rear;
...
typedef struct __attribute__((packed)) queue2048
{
    uint16_t    Front;
    uint16_t    Rear;
